            ...
            <ul>
               ...
               <hr style={{color:"white"}} /> */}
                  ...
                  {currentUser.user.isAdmin ? (
                      ...
                      <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/Recommandation"  
                        style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Circulation </Link>  </li>
                       <hr style={{color:"white"}} />
               ...
               <hr style={{color:"white"}} />
                       ...
                       <li> <i className="fas fa-users text-white"></i> <Link  to="/dashboard/addEmployee" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Add Student </Link>  </li>
                       <hr style={{color:"white"}} />
                       </>
